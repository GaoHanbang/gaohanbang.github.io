...
video: "/videos/tase.mp4"
poster: "/images/tase_poster.jpg"
...
<div class="local-video-box" style="margin-top: 20px;">
  <video controls playsinline preload="none" poster="{{ "/images/tase_poster.jpg" | relative_url }}" style="width:100%;max-width:640px;border-radius:8px;">
    <source src="{{ "/videos/tase.mp4" | relative_url }}" type="video/mp4">
